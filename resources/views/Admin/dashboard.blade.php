                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body d-flex justify-content-around">
                            ...
                            <div>
                                <h5 class="mb-1 mt-1">{{ App\Models\User::where('type', 'customer')->count() }}</span>
                                    </h4>
                        ...
                        <div class="card-body d-flex justify-content-around">
                            ...
                            <div>
                                <h4 class="mb-1 mt-1"><span
                                        data-plugin="counterup">{{ App\Models\User::where('type', 'freelancer')->count() }}</span>
                                </h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <div id="sales-analytics-chart"
                                    data-colors='["--bs-primary", "#dfe2e6", "--bs-warning"]' class="apex-charts"
                                    dir="ltr"></div>
                            </div>
                        </div> <!-- end card-body-->
                    </div> <!-- end card-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-3">
                                <div class="col-sm-3">
                                    <p class="text-truncate mt-1 mb-0"><i
                                            class="mdi mdi-circle-medium text-primary me-2"></i> Reservation </p>
                                </div>
                            ...
                            <div class="row align-items-center g-0 mt-3">
                                <div class="col-sm-3">
                                    <p class="text-truncate mt-1 mb-0"><i
                                            class="mdi mdi-circle-medium text-info me-2"></i> Requests </p>
                                </div>
                                <div class="col-sm-9">
                                    <div class="progress mt-1" style="height: 6px;">
                            ...
                            <div class="row align-items-center g-0 mt-3">
                                <div class="col-sm-3">
                                    <p class="text-truncate mt-1 mb-0"><i
                                            class="mdi mdi-circle-medium text-success me-2"></i> product </p>
                                </div>
                                <div class="col-sm-9">
                                    <div class="progress mt-1" style="height: 6px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="javascript: void(0);"
                                                    class="text-body fw-bold">#{{$payment->id}}</a> </td>
                                            <td>{{App\Models\User::find($payment->user_id)->name}}</td>


                                            <td>
                                                {{  date_format($payment->created_at,' h:m  Y-m-d ')}}
                                            </td>
                                            <td>
                                                {{$payment->total}}
                                            </td>
