            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body d-flex justify-content-around">
                        ...
                        <div>
                            <h5 class="mb-1 mt-1">{{ App\Models\User::where('type', 'customer')->count() }}</span></h4>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body d-flex justify-content-around">
                        ...
                        <div>
                            <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ App\Models\User::where('type', 'freelancer')->count() }}</span></h4>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body d-flex justify-content-around">
                        ...
                        <div>
                            <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ App\Models\Category::count() }}</span></h4>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-body d-flex justify-content-around">
                        ...
                        <div>
                            <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ App\Models\Product::count() }}</span></h4>
