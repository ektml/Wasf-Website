...
<div class="showrequest">
  <div class="container">
    ...
    <div class="requestlink py-4 d-flex justify-content-evenly align-items-center">
      <a href="{{route('freelanc.neworder')}}" class="active  fs-4"> {{__('request.new orders')}}</a>
      <a href="{{route('freelanc.mywork')}}" class=" fs-4 text-black-50 ">{{__('request.mywork')}}</a>
    </div>
    ...
    <div class="requesties d-flx flex-column pt-4">
      ...
      <div class="privateorders p-2  my-5 ">
        <h3 class="py-3"> {{__('request.private orders')}}</h3>
        ...
        <a data-bs-toggle="modal" href="#freelancerorderpeindingwithoffer{{$request->id}}" role="button"
          class="request  d-flex flex-column px-3 py-3 position-relative mb-5">
          @else

          <a data-bs-toggle="modal" href="#feelancerrequstPendingcancancel{{$request->id}}" role="button"
            class="request  d-flex flex-column px-3 py-3 position-relative mb-5">
