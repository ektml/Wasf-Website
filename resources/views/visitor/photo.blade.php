        ...
        <div class="header d-flex align-items-center">
                ...
                <div class="info d-flex flex-column  ">
                    ...
                    <div class="freelancer-info d-flex ">
                        ...
                        <div class="freelacer-rate">
                            ...
                            <span> @if(
                                App\Models\Review::select('rate')->where('freelancer_id',$freelancer->id)->count()>0)
            ...
            <div class="service d-flex justify-content-end  flex-1">
                <div class="serv d-flex align-items-center">
                    ...
                    <button class="btn  btn-modal  my-3 btn-model-primary" data-id="{{$photo->id}}"
                        onclick="addcart(this)" data-type='photo'>in cart</button>
                    @else
                    <button class="btn  btn-modal  my-3 btn-model-primary" data-id="{{$photo->id}}"
                        onclick="addcart(this)" data-type='photo'>{{__('translate.addtocart')}}</button>
                    @endif
                ...
                <div class="row">
                    ...
                    <div class="card col-xs-12 col-sm-12 col-md-6 col-lg-4" style="max-width: 300px">
                        <div class="image-product  im-product">
                            <img src="{{asset('assets/images/photo/'.$s->photo) }}" class="card-img-top"
                                alt="product image">
                            @auth
                            <button type="button" data-type="photo" data-id="{{$s->id}}" onclick="likes(this)"
