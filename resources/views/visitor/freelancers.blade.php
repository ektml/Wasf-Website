    ...
    <div class="container-fluid d-flex  px-0 ">
        <div class="category-table">
            <ul class="category">
                ...
                <li><a href="{{route('freelancers',['cat_id'=>$category->id])}}" @if(isset($cat_id) &&
                        $cat_id==$category->id)
                        class="active"
                        @endif >
                        @if(app()->getLocale()=='ar')
            ...
            <div class="filtercontainer d-flex align-items-baseline justify-content-start mb-2 mx-2">
                ...
                <div class="filter-items">
                    <form action="{{route('freelancers')}}">
                        ...
                        @endif
                        <div>
                            <input type="checkbox" name="freelancsearch[]" value="highestrating" id="highestrating"
                                @if(in_array('highestrating',$filter)) checked @endif>
                            <label for="highestrating" class="bold">{{__('translate.highest rating')}}</label>
                        </div>

                        <div>
                            <input type="checkbox" name="freelancsearch[]" value="moreproject" id="moreproject"
                                id="moreproject" @if (in_array('moreproject',$filter)) checked @endif>
