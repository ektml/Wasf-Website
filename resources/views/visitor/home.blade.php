        ...
        <div class="row">
            <div class="col-lg-4 message d-flex flex-column align-items-center justify-content-center text-center mb-5">
                ...
                <div class="text">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora accusamus cum a tempore alias
                        veritatis repudiandae in fugiat. Nemo dicta vitae aliquam, eius aperiam qui corporis enim
                        voluptas molestias in!</p>
                </div>
            </div>
            <div class="col-lg-4 message d-flex flex-column align-items-center justify-content-center text-center mb-5">
...
<div class="categories pt-3">
    <div class="container py-3 scrollable-container">
        ...
        <div class="scrollable d-flex">
            ...
            <div class="category ">
                <div class="image" style="display: flex; justify-content: center; align-items: center;"><i
                        style="font-size: 6rem;" class="fa {{ $category->icon }}"></i></div>
    ...
    <div class="container py-3">
        ...
        <div class="about-data">
            ...
            <div class="about-text ">
                @if (app()->getLocale()=='ar')
                {{ App\Models\AboutUs::first()->paragraph_ar}}

                @else
                {{ App\Models\AboutUs::first()->paragraph_en}}
                @endif
