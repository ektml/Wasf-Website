        ...
        <div class="header d-flex align-items-center">
                ...
                <div class="info d-flex flex-column  ">
                    ...
                    <div class="freelancer-info d-flex  ">
                        <div class="d-flex ">
                            <div class="image">
                                <img
                                    src="{{ asset('Admin3/assets/images/users/'.App\Models\User::where('id', $product->freelancer_id)->first()->profile_image) }}">

                            </div>
                            <p class="card-text ">{{\APP\Models\User::find($product->freelancer_id)->name}} <span
                                    class="text-black-50 px-2">|</span></p>
                        </div>
                        <div class="freelacer-rate">
                            <i class="fa-solid fa-star align-self-center"></i>
                            <span>
                                @if(
                                App\Models\Review::select('rate')->where('freelancer_id',$product->freelancer_id)->count()>0)
            ...
            <div class="service d-flex justify-content-end  flex-1">
                <div class="serv d-flex align-items-center">
                    ...
                    <button class="btn  btn-modal  my-3 btn-model-primary" data-id="{{$product->id}}"
                        onclick="addcart(this)" data-type='product'> {{__('translate.in cart')}}</button>
                    @else
                    <button class="btn  btn-modal  my-3 btn-model-primary" data-id="{{$product->id}}"
                        onclick="addcart(this)" data-type='product'>{{__('translate.addtocart')}}</button>
                    @endif
                    ...
                    @else
                    <button class="btn  btn-modal  my-3 btn-model-primary" data-bs-target="#login2"
                ...
                <div class="row">
                    ...
                    <div class="card col-xs-12 col-sm-12 col-md-6 col-lg-4" style="max-width: 300px">
                        <div class="image-product im-product">
                            ...
                            @endforeach
                            @auth
                            <button type="button" data-type="product" data-id="{{$s->id}}" onclick="likes(this)"
                            ...
                            <button class="addtochart" data-id="{{$s->id}}" onclick="addcart(this)"
                                data-type='product'>{{__('addtocart')}}</button>
                            @endif
                        ...
                        <div class="card-body">
                            ...
                            <div class="freelancer-info d-flex align-items-center ">
                                <div class="image">
                                    <img src="{{ asset('Admin3/assets/images/users/'.App\Models\User::where('id', $s->freelancer_id)->first()->profile_image) }}"
                                        alt="">
                                </div>
