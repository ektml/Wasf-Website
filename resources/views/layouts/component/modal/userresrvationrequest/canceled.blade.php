<div id="canceleduserreservation{{ $request->id }}" class="modal offers fade" aria-hidden="true"
            ...
            <div class="modal-body">
                <div class="div d-flex justify-content-start px-4">
                    ...
                    <div class="align-slef-end"
                        ...
                        <a href="#" data-bs-toggle="offcanvas" data-bs-target="#chat{{$request->id}}"
                ...
                <div class="d-flex flex-column px-5">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="fw-900 mb-0 text-black">
                                {{ \Carbon\Carbon::parse($request->from)->format('h:m A')}}</p>
                            <span class="text-black-50 mx-1">{{__('request.to')}}</span>
                            <p class="fw-900 mb-0 text-black">{{ \Carbon\Carbon::parse($request->to)->format('h:m A')}}
                            </p>
                        </div>
                    </div>
