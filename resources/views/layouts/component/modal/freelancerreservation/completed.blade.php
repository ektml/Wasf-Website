<div class="modal offers fade" id="freelancerreservationcompleted{{ $request->id }}" aria-hidden="true"
            ...
            <div class="modal-body">
                ...
                <div class="d-flex flex-column px-5">
                    ...
                    <div class="btn-contianer d-flex flex-column justify-between align-items-center my-3">
                        <button class="btn btn-modal btn-model-primary" type="button" data-bs-toggle="modal"
                            data-bs-target="#review{{$request->id}}">{{__('request.Rate')}}</button>
                    </div>
                    @else
                    <div class="myreview flex-column py-3">
                        <div class="d-flex">
                            <h5 class="flex-grow-1 fw-900">{{__('request.your review')}}</h5>
    ...
    <div style="position:fixed ; bottom:0;right:0; font-size:30px"><button class="addrequesticon" type="button"
            data-bs-toggle="offcanvas" data-bs-target="#chat{{$request->id}}" aria-controls="offcanvasRight"><i
