<!-- Modal -->
<div class="modal fade " id="sendofferforreservation{{$request->id}}" aria-hidden="true"
            ...
            <div class="modal-body">
                ...
                <form action="{{route('freelanc.reservation.editoffer',$request->id)}}" method="GET">
                    ...
                    <form action="{{route('freelanc.reservation.sendoffer',$request->id)}}" method="GET">
                        ...
                        <div class="btn-contianer d-flex justify-between align-items-center"></div>
                            <button type="submit"
                                class="btn  btn-modal  my-3 btn-model-primary ">{{__('translate.send')}}</button>
