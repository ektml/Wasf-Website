<div id="freelancerreservationrejectorcancle{{ $request->id }}" class="modal offers fade" aria-hidden="true" aria-labelledby="staticBackdropLabel" tabindex="-1">
        ...
        <div class="modal-body">
          ...
          <div class="div d-flex justify-content-start px-4">
              <div class="d-flex flex-column">
                ...
                <span class="craz-color">{{__('requests.'.$request->status)}}</span>
              </div>
...
<a  href="#" data-bs-toggle="offcanvas" data-bs-target="#chat" aria-controls="offcanvasRight">
    <i class="uil-comments-alt"  style="font-size:20px;"></i>
          ...
          <div class="d-flex justify-content-between">
              <p class=" mb-0" >C{{__('request.Customer Name')}}</p>
