<div id="feelancerReservationPendingAceptOrReject{{ $request->id }}" class="modal offers fade" aria-hidden="true"
            ...
            <div class="modal-body">
                ...
                <div
                    ...
                    <form action="{{ route('freelanc.reservation.reject', $request->id) }}" method="GET"
                        ...
                        @csrf
                        <input type="submit" name="status" value="{{__('request.Reject')}}"
