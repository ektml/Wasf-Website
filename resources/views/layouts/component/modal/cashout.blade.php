    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="{{ route('register') }}">
          @csrf
          <h1 class="modal-title fs-5"> {{__('translate.Cash out')}}</h1>
          <div class=" seeamount mb-3">
            ...
            <div class="d-flex justify-content-around">
              ...
              <button id="seeamount" class="btn-noborder">{{__('translate.All')}}</button>
            </div>
          </div>
          ...
          <div class=" mb-2">
            <label class="form-label" for="bankname"> {{__('translate.Bank name')}}</label>
            <div class="">
          ...
          <div class=" mb-2">
            <label class="form-label" for="accountnumber">{{__('translate.Account number')}}</label>
            <div class="">
          ...
          <div class=" mb-2">
            <label class="form-label" for="iban">{{__('translate.IBAN')}}</label>
            <div class="">
          ...
          <div class="btn-contianer d-flex justify-content-between align-items-center">
            <button type="submit" class="btn  btn-modal  my-3 btn-model-primary">{{__('translate.Transfer')}}</button>
