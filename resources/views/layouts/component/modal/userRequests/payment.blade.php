<div class="modal offers fade  modal-uk pay" id="pay{{$request->id}}" aria-hidden="true"
        ...
        <div class="wallet  paycard">
          <div class="wallet-empty" style="height:100%">
            <div class=" d-flex flex-column align-items-center justify-content-center w-100" style="height:100%">
              ...
              <p style="color:#011C26;" class="text-center py-3">
                {{__("translate.Your wallet is empty or haven't enough balance")}} </p>
            </div>
