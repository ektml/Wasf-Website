        ...
        <div class="container-fluid nav2-head">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-capitalize active" aria-current="page" href="{{route("home")}}"
                            style="color: #fff;">{{__('translate.home')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-capitalize" href="{{route("products")}}"
                            style="color: #fff;">{{__('translate.products')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-capitalize" href="{{route("freelancers")}}"
                            style="color: #fff;">{{__('translate.freelancers')}}</a>
                    </li>
                    <li class="nav-item text-capitalize text-white-100">
                        <a class="nav-link text-capitalize" href="#login" class="btn" data-bs-toggle="modal"
                            style="color: #fff;">{{__('translate.login')}}</a>
